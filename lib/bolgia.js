...
exports.Bolgia = ( function () {
    var log = console.log
        , Funny = require( 'funny' )
        // Array.prototype.toString shortcut
        , otype = Funny.toString
        // Array.prototype.slice shortcut
        , slice = Funny.slice
        // toString table
        , o = {
        ...
        , flatten : function ( hash, opt ) {
           ...
           if ( htype === o.obj ) {
                if ( h.constructor === Object ) {
                    for ( k in h ) {
                        update( encodeURIComponent( f ), flatten( k, h[ k ] ) );
                    };
                }
            };
            return f;
           ...
           if ( htype === o.obj ) {
                if ( h.constructor === Object ) {
                    for ( k in h ) {
                        ...
                        s += qs( encodeURIComponent( k ), h[ k ], cfg );
                    };
                }
            };
            // remove trailing '&'
